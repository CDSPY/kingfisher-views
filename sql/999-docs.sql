...
BEGIN
    ...
    'Comment on column %%1$s.total_tender_documents IS ''Count of tender documents in this release''; '
    'Comment on column %%1$s.tender_documenttype_counts IS ''JSONB object with the keys as unique tender/documents/documentType and the values as count of the appearances of those documentTypes''; '
